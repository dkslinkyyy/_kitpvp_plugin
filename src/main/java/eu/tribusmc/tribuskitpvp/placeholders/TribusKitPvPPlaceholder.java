...
public class TribusKitPvPPlaceholder extends PlaceholderExpansion {
    private final Core plugin;

    public TribusKitPvPPlaceholder(Core plugin){
        this.plugin = plugin;
    }
    ...
    public String onPlaceholderRequest(Player player, @NotNull String identifier){
        ...
        placeholderImpl =  plugin.getPlaceholderCollector().fetchMatching(identifier);

...
/**
 * TextBuilder: Create JSON messages with clickable events and hover events quickly, easily and simply without having to deal with the extremely-careful JSON syntax
 *
 * @author ReflxctionDev // xTechno
 */
